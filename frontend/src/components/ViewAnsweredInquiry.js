...
const ViewAnsweredInquiry = () => {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3001/api/inquiryanswereddetail/${id}`)
                    ...
                    {inquiryDetails ? (
                        <>
                            <div className="inquiry-detail">
                                ...
                                <p><strong>Answer:</strong> {inquiryDetails[0].answer}</p>
                            </div>
...
export default ViewAnsweredInquiry;
